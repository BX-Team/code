...
/// Only Atlas is documented publicly. Pulsify and auth stay out of the document until they leave
/// the closed beta; their handlers keep their `utoipa::path` attributes so listing them here is all
