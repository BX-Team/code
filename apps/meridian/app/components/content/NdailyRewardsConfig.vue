...
const config = {
	...
	"rewards": {
		...
		"timezone": "system",
		"days": {
			"1": { "position": 10, "lore": ["&7&lRewards:", "&6- &e1x &6Diamond"], "actions": ["[console] give <player> diamond 1", "[message] &6You have claimed your reward!", "[sound] ENTITY_EXPERIENCE_ORB_PICKUP:1:1"] },
			"2": { "position": 11, "lore": ["&7&lRewards:", "&6- &e2x &6Diamond"], "actions": ["[console] give <player> diamond 2", "[message] &6You have claimed your reward!", "[sound] ENTITY_EXPERIENCE_ORB_PICKUP:1:1"] },
			"3": { "position": 12, "lore": ["&7&lRewards:", "&6- &e3x &6Diamond"], "actions": ["[console] give <player> diamond 3", "[message] &6You have claimed your reward!", "[sound] ENTITY_EXPERIENCE_ORB_PICKUP:1:1"] },
			"7": { "position": 16, "lore": ["&7&lRewards:", "&6- &e7x &6Diamond"], "actions": ["[console] give <player> diamond 7", "[message] &6You have claimed your reward!", "[sound] ENTITY_EXPERIENCE_ORB_PICKUP:1:1"] }
		}
	},
	"gui": {
		"reward": {
			...
			"size": 27,
			"display": {
				"available": { "material": "EMERALD_BLOCK:1", "name": "&aDay <dayNum>", "lore": ["&7Your Reward Awaits", "&7Click Me to claim your prize!", "", "<reward-lore>"] },
				"claimed": { "material": "COAL_BLOCK:1", "name": "&aDay <dayNum>", "lore": ["&7You have claimed this reward", "", "<reward-lore>"] },
				"next": { "material": "COAL_BLOCK:1", "name": "&aDay <dayNum>", "lore": ["&7Your Reward Will Be Here Soon", "&7Wait <time-left>", "", "<reward-lore>"] },
				"unavailable": { "material": "BARRIER:1", "name": "&aDay <dayNum>", "lore": ["&7You have not reached this day yet", "", "<reward-lore>"] },
...
const comments: Record<string, string> = {
	...
	"rewards.days": "Daily reward configurations. Actions: [console], [player], [message], [actionbar], [title], [subtitle], [sound], [permission], [luck], [close]",
