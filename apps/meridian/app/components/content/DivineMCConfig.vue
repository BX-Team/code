...
const comments: Record<string, string> = {
  ...
  'network.general.optimize-non-flush-packet-sending':
    "Optimizes non-flush packet sending by using Netty's lazyExecute method.\n\nNOTE: NOT compatible with ProtocolLib!",
  ...
  'network.general.send-spectator-change-packet':
    'When disabled, tab list will not show the player entered spectator mode.',
  ...
  'async.parallel-world-ticking.enable':
    "Executes each world's tick in a separate thread while ensuring all worlds complete before the next cycle.",
  'async.parallel-world-ticking.disable-hard-throw':
    "Disables 'not on main thread' throws. NOT RECOMMENDED — may cause data corruption!",
